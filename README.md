...
Step # 02:( Creating Apps in Django Framework ) :-
        ...
        - Create the urls.py in the apps folder and then add the app-url in the main
          project urls.py .
...
Step # 04:( Creating a Python API Client ) :-
        ...
        -- In basic.py create variable named as endpoint/apiname/url and create url of 
           api.
...
Step # 14:( Update APIView and Destroy APIView ) :-
        ...
        - Create API View :
         > Update a product ;
                  ...
                  (modelnameUpdateAPIView).
                 - PUT: Updates all fields of a product.
                 - PATCH: Updates only the provided fields.

         > Delete a Product ;
                   define built-in view in views.py using 
                   (modelnameDestroyAPIView).
